...
%% Allocate imported array to column variable names
    SAETurbMap.speed = cell2mat(raw(:, 1));
    SAETurbMap.m_dot = cell2mat(raw(:, 2));
    SAETurbMap.ER = cell2mat(raw(:, 3));
    SAETurbMap.eff = cell2mat(raw(:, 4));
...
clearvars lock endRow filterIndex startRow
