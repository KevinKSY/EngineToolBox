...
% Last Modified by GUIDE v2.5 10-Apr-2015 16:34:01
...
handles.SAE_map_comp = varargin{1};
DrawComp(handles.SAE_map_comp,[],[],[],handles.CompMap);
RPMCompRep = num2cell(unique(handles.SAE_map_comp.RPM));
set(handles.RPMLB,'Value',RPMCompRep);
