function dNO = dNOOppenauer(t,NO,timeSim,pCyl,TCyl,FCyl,vCyl,fs,varargin)
...
k11 = 13e10*exp(-38230/T);
k12 = 2.8e10;
k21 = 6.4e6*T*exp(-3145/T);
k22 = 1.5e6*T*exp(-19635/T);
k31 = 4.2e10;
k32 = 1.3e11*exp(-22865/T);
...
%     dcNO = 0;
% else
dcNO = 2*R1*(1-cNO^2/(k11*k21*c(11)*c(8)/(k12*k22))) / (1+k12*cNO/(k21*c(8)+k31*c(5)));
% end;
dNO = dcNO*v;
